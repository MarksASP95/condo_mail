import { getSpinnerEl } from "./domElements";

// const spinnerEl = getSpinnerEl();

const spinnerStr = `
  <div id="spinner">
    <div class="loadingio-spinner-spinner-8u7b7o86c"><div class="ldio-s9pjjoqehs8">
...
export function toggleSpinner(show: boolean) {
  if (show) {
    document.body.insertAdjacentHTML("beforeend", spinnerStr);
  } else {
